...
- The near-land distance is 100 m, measured from the polygon edge to the pixel centre. It is provisional, assumption A21.
...
Level-2A is processed per tile. In the overlap between neighbours the classification can differ and the aerosol and reflectance are generally different, claim G11 in [s2-best-practices.md](../s2-best-practices.md).
...
- The strict interior rule meets registration error of a few metres, issue I-15. It is accepted now and revisited after measurement.
