...
This file provides persistent project guidance for Codex and other agents using `AGENTS.md`.
Keep conventions in `CLAUDE.md` and decisions in [docs/decisions/](docs/decisions/README.md). Link instead of copying them here.
Preserve staged changes from another reviewer. Present your follow-up changes separately for review.
